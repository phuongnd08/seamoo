...
import org.seamoo.daos.jdoImpl.JdoLeagueDaoImpl;
import org.seamoo.daos.jdoImpl.JdoSubjectDaoImpl;
...
public class JdoLeagueDaoImplTest extends LocalDatastoreTest {
	LeagueDao leagueDao;
	...
	public void setUp() {
		...
		super.setUp();
		leagueDao = new JdoLeagueDaoImpl();
