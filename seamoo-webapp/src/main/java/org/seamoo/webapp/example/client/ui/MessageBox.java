package org.seamoo.webapp.example.client.ui;

import java.util.Collection;

import org.seamoo.webapp.example.client.MessagesServiceAsync;
...
public class MessageBox extends VerticalPanel {
	...
	public void update() {
		AsyncCallback<Collection> callback = new AsyncCallback<Collection>() {
